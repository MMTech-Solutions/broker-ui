...
const BONUS_NEGATIVE_BALANCE_COMPENSATIONS_PATH = "v1/admin/bonus-negative-balance-compensations";
...
export async function listBonusNegativeBalanceCompensations(filters: Record<string, string | number | boolean> = {}): Promise<BrokerSuccessResponse<BonusNegativeBalanceCompensation[]>> {
  return browserBrokerRequest<BonusNegativeBalanceCompensation[]>(BONUS_NEGATIVE_BALANCE_COMPENSATIONS_PATH, { searchParams: compactFilters(filters) });
}
