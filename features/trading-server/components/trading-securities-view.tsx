...
type TradingSecuritiesViewProps = {
  platformId: string;
...
export function TradingSecuritiesView({
  platformId,
  tradingServerId,
}: TradingSecuritiesViewProps) {
      ...
      try {
        const [platformResult, serverResult, securitiesResponse] =
          await Promise.all([
            ...
            listSecurities(tradingServerId, {
              name: name || undefined,
              page: requestedPage,
              per_page: 15,
            }),
      ...
      <div className="rounded-xl border p-4">
        ...
        <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
          <div className="space-y-2">
            <Label htmlFor="filter-security-name">Name</Label>
            <Input
              id="filter-security-name"
              value={nameFilter}
          ...
          <TableBody>
            ...
            {!loading && securities.length === 0 ? (
              <TableRow>
                ...
                >
                  No securities found for this trading server.
                </TableCell>
              </TableRow>
            ) : null}
